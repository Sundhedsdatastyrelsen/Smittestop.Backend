...
namespace DIGNDB.APP.SmitteStop.Jobs
{
    public class ScheduledJobsConfiguration
    {
        ...
        public static void ConfigureScheduledJobs(HangfireConfig hangfireConfig)
        {
            ...
            var processSSIDataInFolderConfig = jobsConfig.ProcessSSIDataInFolder;
            RecurringJob.AddOrUpdate<ProcessSsiDataInFolderJob>(recurringJobId: processSSIDataInFolderConfig.Name, methodCall: job => job.UpdateCovidStatistics(), processSSIDataInFolderConfig.CronExpression);
