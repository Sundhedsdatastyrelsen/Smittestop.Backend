...
namespace DIGNDB.App.SmitteStop.Testing.ControllersTest.V2
{
    ...
    public class DiagnosticKeysControllerV2Tests
    {
        ...
        private Mock<ICacheOperationsV2> _cacheOperationsV2Mock;
        ...
        public void Init()
        {
            ...
            _controller = new DiagnosticKeysControllerV2(_logger.Object, _appleService.Object, _configuration.Object,
                    ...
                    _zipFileInfoService.Object, _appSettingsConfigMock.Object, _cacheOperationsV2Mock.Object)
        ...
        private void SetupMockServices()
        {
            ...
            _cacheOperationsV2Mock = new Mock<ICacheOperationsV2>(MockBehavior.Strict);
            SetupMockConfiguration();
            SetupMockExposureConfigurationService();
            SetupMockZipFileInfoService();
            SetupMockCacheOperations();
        }

        private void SetupMockCacheOperations()
        {
            _cacheOperationsV2Mock.Setup(x => x.GetCacheValue(It.IsAny<ZipFileInfo>(), It.IsAny<string>(), It.IsAny<bool>()))
