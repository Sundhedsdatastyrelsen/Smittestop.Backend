...
namespace DIGNDB.App.SmitteStop.Testing.ServiceTest
{
    ...
    public class CacheOperationsV2Tests
    {
        ...
        private Mock<ILogger<CacheOperationsV2>> _logger;
        private CacheOperationsV2 _cacheService;
        ...
        public void Init()
        {
            ...
            _logger = new Mock<ILogger<CacheOperationsV2>>();
            ...
            _cacheService = new CacheOperationsV2(_memoryCache, _configuration.Object, _logger.Object, _zipFileInfoService.Object);
        }
