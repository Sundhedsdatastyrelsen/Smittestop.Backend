...
namespace DIGNDB.App.SmitteStop.Testing.ServiceTest.Gateway
{
    public class EuGatewayServiceDownloadTest
    {
        ...
        public void CreateDataSet()
        {
            ...
            _countryRepository = new CountryRepository(_dbContext, translationsRepositoryMock.Object);
            ...
            _loggerGatewayWebContextReader = _mockRepository.Create<ILogger<IGatewayWebContextReader>>();
            ...
            _spain = TestCountryBuilder.Spain.Build();
            _latviaDisabledDownload = TestCountryBuilder.Latvia
                .SetIsPullingFromGatewayEnabled(false)
                .Build();

            _dbContext.AddRange(new Country[] { _denmark, _poland, _germany, _spain, _latviaDisabledDownload });
        ...
        public void DownloadKeysFromMultipleCountries_ShouldSaveOnlyValidKeysFromEnabledOrgins()
        {
            ...
            // doesn't have DK in VisitedCountries - should be rejected
            var germanInvalidKeysBuilder1 = germanDefaultBuilder.Copy().SetVisitedCountries(new Country[] { _poland });
            // invalid RollingStartNumber - should be rejected
            var germanInvalidKeysBuilder2 = germanDefaultBuilder.Copy()
            ...
            var dayOneInvalidKeysBatch1 = new List<TemporaryExposureKey>()
                .Concat(germanInvalidKeysBuilder1.BuildNormalized(new[] { "DE1.1_INV1", "DE1.1_INV2" }));
            // day #1 - batch 2
            ...
            var dayTwoInvalidKeysBatch2 = new List<TemporaryExposureKey>()
                ...
                .Concat(germanInvalidKeysBuilder2.BuildNormalized(new[] { "DE2.2_INV3" }));
            // day #3 - batch 1
            ...
            keyBatchesDict.Add(key: daysOneBatchTag1, value: dayOneValidKeysBatch1.Concat(dayOneInvalidKeysBatch1));
        ...
        {
            _keysRepository = new TemporaryExposureKeyRepository(_dbContext, _countryRepository, _mockLogger.Object);
            ...
            var keyFilter = new KeyFilter(_autoMapper, keyValidator);
            ...
            addTemporaryExposureKeyService
                ...
                .ReturnsAsync((List<TemporaryExposureKey> argument) => argument);
