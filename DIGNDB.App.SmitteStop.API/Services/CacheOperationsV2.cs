...
{
    public class CacheOperationsV2 : ICacheOperationsV2
    {
        private const int DefaultCacheMonitorTimeout = 100;
        private readonly ILogger<CacheOperationsV2> _logger;
        ...
        public CacheOperationsV2(IMemoryCache memoryCache, IConfiguration configuration, ILogger<CacheOperationsV2> logger, IZipFileInfoService zipFileInfoService)
        {
