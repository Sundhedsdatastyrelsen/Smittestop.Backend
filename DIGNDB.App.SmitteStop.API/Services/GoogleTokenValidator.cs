...
namespace DIGNDB.App.SmitteStop.API.Services
{
    public static class GoogleTokenValidator
    {
        ...
        public static AttestationStatement ParseAndVerify(string signedAttestationStatement)
        {
            ...
            var token = new JwtSecurityToken(signedAttestationStatement);
        ...
        /// <summary>
        /// Verifies an X509Security key, and checks that it is issued for a given hostname.
        /// </summary>
        ...
        private static bool VerifyHostname(string hostname, X509SecurityKey securityKey)
        {
            ...
            var commonName = securityKey.Certificate.GetNameInfo(X509NameType.DnsName, false);
