...
namespace DIGNDB.App.SmitteStop.API.HealthCheckAuthorization
{
    ...
    public class HealthCheckAuthorizationHandler : AuthorizationHandler<HealthCheckAuthorizationRequirement>
    {
        ...
        private static string _tokenJsonKey = "Authorization_HealthCheck";
        ...
        public HealthCheckAuthorizationHandler(ApiConfig config, IHttpContextAccessor httpContextAccessor, AuthOptions authOptions, ILogger<HealthCheckAuthorizationHandler> logger)
        {
            _httpContextAccessor = httpContextAccessor;
            _authOptions = authOptions;
            _logger = logger;

            _tokenEncrypted = config.AppSettings.AuthorizationHealthCheck; 
        }

        /// <summary>
        /// Handles authorization by inspecting token in header for value "Authorization_HealthCheck" <seealso cref="Attributes.ApiKeyAuthorizationAttribute"/>
        /// </summary>
