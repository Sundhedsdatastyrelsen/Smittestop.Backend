...
namespace FederationGatewayApi.Services
{
    public class EFGSKeyStoreService : IEFGSKeyStoreService
    {
        ...
        {
            int? daysSinceOnsetOfSymptomsOriginalValue = key.DaysSinceOnsetOfSymptoms;
            ...
            _logger.LogInformation($"Converted DaysSinceOnsetOfSymptoms from {daysSinceOnsetOfSymptomsOriginalValue} to {key.DaysSinceOnsetOfSymptoms} and set RiskIndex to: {key.TransmissionRiskLevel}");
        }
