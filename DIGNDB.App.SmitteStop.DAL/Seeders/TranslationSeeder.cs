    ...
    public class TranslationSeeder
    {
        public IEnumerable<dynamic> GetSeedData()
        {
            return new[]
            {
                ...
                new {Id = 55L, EntityId = 29L, EntityName = nameof(Country), Value = "Norge", LanguageCountryId = CountrySeeder.DenmarkCountryId, EntityPropertyName = nameof(CountryDto.NameInDanish)},
                new {Id = 57L, EntityId = 30L, EntityName = nameof(Country), Value = "Island", LanguageCountryId = CountrySeeder.DenmarkCountryId, EntityPropertyName = nameof(CountryDto.NameInDanish)},
                new {Id = 58L, EntityId = 31L, EntityName = nameof(Country), Value = "Liechtenstein", LanguageCountryId = CountrySeeder.DenmarkCountryId, EntityPropertyName = nameof(CountryDto.NameInDanish)},
                new {Id = 59L, EntityId = 32L, EntityName = nameof(Country), Value = "Schweiz", LanguageCountryId = CountrySeeder.DenmarkCountryId, EntityPropertyName = nameof(CountryDto.NameInDanish)},
                ...
                new {Id = 56L, EntityId = 29L, EntityName = nameof(Country), Value = "Norway", LanguageCountryId = CountrySeeder.EnglandCountryId, EntityPropertyName = nameof(CountryDto.NameInEnglish)},
                new { Id = 60L, EntityId = 30L, EntityName = nameof(Country), Value = "Iceland", LanguageCountryId = CountrySeeder.EnglandCountryId, EntityPropertyName = nameof(CountryDto.NameInEnglish)},
                new { Id = 61L, EntityId = 31L, EntityName = nameof(Country), Value = "Liechtenstein", LanguageCountryId = CountrySeeder.EnglandCountryId, EntityPropertyName = nameof(CountryDto.NameInEnglish)},
                new { Id = 62L, EntityId = 32L, EntityName = nameof(Country), Value = "Switzerland", LanguageCountryId = CountrySeeder.EnglandCountryId, EntityPropertyName = nameof(CountryDto.NameInEnglish)}
            };
        }
    }
}