...
namespace DIGNDB.App.SmitteStop.DAL.Repositories
{
    public interface ITemporaryExposureKeyRepository
    {
        ...
        int GetCountOfKeysByUploadedDayAndSource(DateTime uploadDate, KeySource gateway);
        ...
        IList<TemporaryExposureKey> GetDkTemporaryExposureKeysUploadedAfterTheDateForGatewayUpload(DateTime uploadedOnAndLater, int numberOfRecordToSkip, int maxCount, KeySource[] sources, bool logInformationKeyValueOnUpload = false);
